...
if  Measurement_flag==1:
	...
	evmsheet.write(0,7,"TX1 EVM_Value dB",stylehead)
	evmsheet.write(0,8,"TX2 EVM_Value dB",stylehead)
	evmsheet.write(0,9,"TX3 EVM_Value dB",stylehead)
	evmsheet.write(0,10,"TX4 EVM_Value dB",stylehead)
	evmsheet.write(0,11,"Upper Limit",stylehead)
	evmsheet.write(0,12,"Lower Limit",stylehead)
	evmsheet.write(0,13,"Target power dBm",stylehead)
	evmsheet.write(0,14,"TX1 Power Value dBm",stylehead)
	evmsheet.write(0,15,"TX2 Power Value dBm",stylehead)
	evmsheet.write(0,16,"TX3 Power Value dBm",stylehead)
	evmsheet.write(0,17,"TX4 Power Value dBm",stylehead)
	evmsheet.write(0,18,"Upper Limit",stylehead)
	evmsheet.write(0,19,"Lower Limit",stylehead)
	...
	powersheet.write(0,7,"TX1 Power Value dBm",stylehead)
	powersheet.write(0,8,"TX2 Power Value dBm",stylehead)
	powersheet.write(0,9,"TX3 Power Value dBm",stylehead)
	powersheet.write(0,10,"TX4 Power Value dBm",stylehead)
	powersheet.write(0,13,"Target Power dBm",stylehead)
	powersheet.write(0,11,"Upper Limit",stylehead)
	powersheet.write(0,12,"Lower Limit",stylehead)
if BT_flag :
...
evm_matrix=np.zeros((3000,3000,4))
power_matrix=np.zeros((3000,3000,4))
evmpower_matrix=np.zeros((3000,3000,4))
...
for line in f:
	...
	if collect_data==1:
					...
					for i in range (len(data_rate)	):	
						...
						if data_rate[i] in line:
							...
							if  Measurement_flag==1:
								...
								evmsheet.write(evmcounter,11,upper_limit)
								evmsheet.write(evmcounter,12,lower_limit)
								if upper_limit=='' :
										uplimitflag=0
								...
								evmsheet.write(evmcounter,13,float(TX_power[i]))
								evmsheet.write(evmcounter,0,current_test_num)
								evmsheet.write(evmcounter,7,evm_values)
								if '.EVM_AVG_1' in line:
									evm_matrix[runID-1,current_test_num-1-i,0]=evm_values
									ant=0
								if '.EVM_AVG_2' in line:
									evm_matrix[runID-1,current_test_num-1-i,1]=evm_values
									ant=1
								evm_sum=0
								...
								if runID==firstID:
									...
									for x in range(1,runID):
										if evm_matrix[x-1][current_test_num-1-i][ant]==0:
											negative+=1
										
										evm_sum+=(evm_matrix[x-1][current_test_num-1-i][ant])
				...
				for i in range (len(data_rate)	):	
					...
					if data_rate[i] in line:
						...
						if  Measurement_flag==1:
							...
							powersheet.write(powercounter,13,float(TX_power[i]))
							...
							if ':POWER_AVERAGE_DBM_VSA1' in line:
								power_matrix[runID-1,current_test_num-1-i,0]=power_values
								ant=0
							if ':POWER_AVERAGE_DBM_VSA2' in line:
								ant=1
								power_matrix[runID-1,current_test_num-1-i,1]=power_values
							if ':POWER_AVERAGE_DBM_VSA3' in line:
								ant=2
								power_matrix[runID-1,current_test_num-1-i,2]=power_values
							if ':POWER_AVERAGE_DBM_VSA4' in line:
								ant=3
								power_matrix[runID-1,current_test_num-1-i,3]=power_values
							...
							if runID==firstID:
								...
								if ((power_values-temp_power)> 1.5) or ((power_values-temp_power)< -1.5):
									powersheet.write(powercounter,7+ant,power_values,style)
								else:
								...
								for x in range(1,runID):
									if power_matrix[x-1][current_test_num-1-i][ant]==0:
										negative+=1
									
									power_sum+=(power_matrix[x-1][current_test_num-1-i][ant])
								...
								if (lowlimitflag):
										if (power_average<lower_limit):
											tempredflag=1
								if (tempredflag):
									powersheet.write(powercounter,7+ant,power_average,style)
								else:
		...
		if evmenable==1 and current_test_num==ref_result_num:				
			if '.POWER_AVG_' in line and 'EVM' in line:
				if '.POWER_AVG_DBM' in line:
					...
					for i in range (len(data_rate)	):	
						...
						if data_rate[i] in line:
							...
							if '.POWER_AVG_1' in line:
								evmpower_matrix[runID-1,current_test_num-1-i,0]=evmpower_values
								ant=0
							if '.POWER_AVG_2' in line:
								evmpower_matrix[runID-1,current_test_num-1-i,1]=evmpower_values
								ant=1
							if '.POWER_AVG_3' in line:
								evmpower_matrix[runID-1,current_test_num-1-i,2]=evmpower_values
								ant=2
							if '.POWER_AVG_4' in line:
								evmpower_matrix[runID-1,current_test_num-1-i,3]=evmpower_values
								ant=3	
							evmpower_sum=0
							...
							if (((evmpower_values-temp_power)> 1.5 or (evmpower_values-temp_power)< -1.5)) and powerenable==0 and Power_QA_report==1:
								...
								QAmessagecounter+=1
							if  Measurement_flag==1:
								evmsheet.write(evmcounter,18,upper_limit)
								evmsheet.write(evmcounter,19,lower_limit)	
								if upper_limit=='' :
									uplimitflag=0
								...
								if runID==firstID:
									if ((evmpower_values-temp_power)>1.5) or ((evmpower_values-temp_power)< -1.5):
										evmsheet.write(evmcounter,14+ant,evmpower_values,style)
									else:	
										evmsheet.write(evmcounter,14+ant,evmpower_values)
								else:
					
									for x in range(1,runID):
										if evmpower_matrix[x-1][current_test_num-1-i][ant]==0:
											negative+=1
										
										evmpower_sum+=(evmpower_matrix[x-1][current_test_num-1-i][ant])
									...
									if (lowlimitflag):
										if (evmpower_average<lower_limit):
											tempredflag=1
									if (tempredflag):	
										evmsheet.write(evmcounter,14+ant,evmpower_average,style)
									else:
			...
			if 'PER_SWEEP.SENS_POWER_LEVEL_DBM' in line:
				...
				for i in range (len(data_rate)	):
					if data_rate[i] in line:
						...
						#check sensitivity against limits
