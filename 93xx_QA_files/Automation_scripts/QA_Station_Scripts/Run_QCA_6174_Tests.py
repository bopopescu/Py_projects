...
##package_name = "IQfact+_QCA_6174_3.2.1.RC3"
##test_mode = "sanity"
##QA_file = "C:\\QA_files"

def Run( package_name, test_mode, QA_file):
	print ("Start Running Run_QCA_6174_Tests.py\n")
	#copy setup files to pkg bin folder
	setup_file_path = os.path.join(QA_file, "Setup_files", "QCA_6174")
	...
	full_tests_list = [ "6174_comp_sht.txt", ]
	quick_tests_list = [ "6174_comp_sht.txt", ]
	...
	if test_mode.lower() == "full":
		...
		print "ERROR: unknown test mode: ", test_mode, ".  Run_QCA_6174_Tests.py aborted.\n"
		exit(4)
	...
	log_file_dir = "C:\\LitePoint\\IQfact_plus\\Automation_log\\QCA_6174"
	...
	os.mkdir(log_file_dir)
	#copy log, results to C:\\LitePoint\\IQfact_plus\\Automation_log\\QCA_6174
	...
	print "Finish Running QCA_6174__Tests.py\n"
