...
# Each item is a tuple in a.items()
# for item in a.items():
#     print(item, end=", ")
# print()
# ('d', 2), ('b', 1), ('c', 3), ('a', 3),

# 2. elements() returns --> an iterator
...
# 4. Counter used as a priority Queue
nums_cnt = Counter()
...
print(list(nums_cnt.elements()))

print(nums_cnt.most_common())
# ['a', 'a', 'a', 'b', 'b', 'c', 'c', 'c', 'd', 'd', 'd', 'e', 'f', 'g']
# [('a', 3), ('c', 3), ('d', 3), ('b', 2), ('e', 1), ('f', 1), ('g', 1)]
