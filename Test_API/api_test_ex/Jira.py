# The Jira REST API enables you to interact with Jira programmatically. Use this API to build apps,
# script interactions with Jira, or develop any other type of integration. This page documents the REST
...
# has been removed from the Jira Cloud REST APIs. In addition,
