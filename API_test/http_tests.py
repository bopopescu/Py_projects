...
with open("src1.json", "r") as fin:
    ...
    # print(f"type(response.json()) is {type(response.json())}") # type(response.json()) is <class 'dict'>
...
# response.headers is {'Date': 'Fri, 13 Dec 2019 22:43:13 GMT', 'Content-Type': 'application/json; charset=utf-8',
# 'Content-Length': '92', 'Connection': 'keep-alive',
# 'Set-Cookie': '__cfduid=d2b79012297c85452f4a19c0033325b6f1576276992; expires=Sun, 12-Jan-20 22:43:12 GMT;
# path=/; domain=.reqres.in; HttpOnly; Secure', 'X-Powered-By': 'Express', 'Access-Control-Allow-Origin': '*',
# 'Etag': 'W/"5c-oOvvBcBfXq6YiarlvMAo3LaIL5Y"', 'Via': '1.1 vegur', 'CF-Cache-Status': 'DYNAMIC',
